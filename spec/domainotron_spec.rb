  ...
  describe 'get_domain_variants' do
    ...
    context 'without www' do
      [
        ...
        ["https://craft.myjetbrains.com", ['craft.myjetbrains.com', "myjetbrains.com"]],
        ...
        ["https://signals.data.production.craft.co", ['signals.data.production.craft.co', 'data.production.craft.co', 'production.craft.co', "craft.co"]],
